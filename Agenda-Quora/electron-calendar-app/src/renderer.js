window.onload = function() {
  ...
  // --- MEMÓRIA DE COMPROMISSOS E NOTAS ---
  const eventsMemory = {};
  const notesMemory = {};
  ...
  // --- VARIÁVEIS E FUNÇÕES DE COMPROMISSOS E NOTAS ---
  ...
  // --- NOTAS ---
  // Renderiza as notas salvas do dia
  ...
  // Salva a nota e mostra na lista
  saveNoteBtn.onclick = () => {
    getNotesForDate(selectedDate, (notes) => {
  ...
  // --- ATUALIZE O renderCalendar PARA CHAMAR renderAgenda/renderNotes ---
